...
2. **Backend Logic (`PayrollCalculationService.cs`):**
   ...
   - _Logic mới:_ Khi tính lương cho một giáo viên X, hệ thống phải quét tất cả các `Sessions` thỏa mãn điều kiện:
...
_(AI Agent khi thực hiện hãy phân tích và ưu tiên chọn **Phương án A** vì nó mang lại Hiệu năng truy vấn (Performance) tốt nhất khi Database phình to)._
